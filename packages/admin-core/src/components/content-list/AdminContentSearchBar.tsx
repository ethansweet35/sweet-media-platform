...
export default function AdminContentSearchBar({
  ...
  return (
    <div className={`${adminPageCardSmCls} mb-4 w-full max-w-full overflow-hidden`}>
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:gap-4">
        <div className="flex w-full min-w-0 max-w-full items-center gap-2 rounded-xl border border-[#E2E8F0] bg-[#F4F7FB] px-3 py-2.5 lg:max-w-sm xl:max-w-md">
          ...
          <input
            ...
            className="min-w-0 w-full flex-1 bg-transparent text-sm text-[#334155] placeholder:text-[#94A3B8] focus:outline-none"
          />
          {value ? (
            <button
              type="button"
