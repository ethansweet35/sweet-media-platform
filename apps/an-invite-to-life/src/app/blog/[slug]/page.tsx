...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://aninvitetolife.com";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `${titleBase} | An Invite To Life`;
  const description =
    metaString(row?.meta_description).trim() ||
    metaString(row?.excerpt).trim() ||
    "Mental health, addiction recovery, and trauma-informed care resources from An Invite To Life.";
