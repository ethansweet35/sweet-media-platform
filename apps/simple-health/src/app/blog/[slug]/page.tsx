...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://getsimplehealth.us";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `${titleBase} | Simple Health`;
  const description =
    metaString(row?.meta_description).trim() ||
    metaString(row?.excerpt).trim() ||
    "Mental health, addiction recovery, and trauma-informed care resources from Simple Health.";
