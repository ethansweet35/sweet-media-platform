...
const fallbackMetadata: Metadata = {
  title: "Blog | Mental Health & Recovery Resources | Simple Health",
  description:
    "Mental health, addiction recovery, trauma-informed care, and wellness resources from Simple Health.",
  keywords:
