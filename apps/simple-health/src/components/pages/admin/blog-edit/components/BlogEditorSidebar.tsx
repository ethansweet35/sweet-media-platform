      ...
      <div className="bg-white rounded-2xl border border-neutral-100 p-5 space-y-4">
        ...
        <div className="bg-neutral-50 rounded-xl p-3 border border-neutral-100">
          ...
          <p className="text-sm font-medium leading-snug line-clamp-1" style={{ color: "#1a0dab" }}>
            {form.excerpt ? form.excerpt.slice(0, 60) + "..." : "Post title here"} | Simple Health
          </p>
          <p className="text-xs mt-0.5" style={{ color: "#006621" }}>getsimplehealth.us/blog/{form.slug || "post-slug"}</p>
