      ...
      <div className={`relative ${CONTAINER} w-full`}>
        <div className="overflow-hidden rounded-[1.75rem] ring-1 ring-white/10 shadow-[0_24px_80px_-20px_rgba(10,15,20,0.55)]">
          <div className="grid lg:grid-cols-2">
            <div className="flex flex-col justify-center border-b border-white/8 p-8 lg:border-b-0 lg:border-r lg:p-12">
            ...
            <div className="flex flex-col justify-center bg-white/[0.04] p-8 lg:p-12">
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
                <a
                  ...
                  className="inline-flex flex-1 items-center justify-center gap-2.5 rounded-xl bg-white px-6 py-3.5 text-sm font-bold text-ink transition hover:bg-white/90"
                >
                ...
                <Link
                  href="/admissions"
                  className="inline-flex flex-1 items-center justify-center gap-2 rounded-xl border border-white/12 bg-white/5 px-6 py-3.5 text-sm font-semibold text-white transition hover:border-white/25 hover:bg-white/10"
                >
                  Start Intake
