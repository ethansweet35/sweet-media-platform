...
import DepressionTreatmentPage from "@/views/treatment/DepressionTreatmentPage";

const config = TREATMENT_LANDING_PAGES["/teen-depression-treatment"];
...
export default function Page() {
  return (
    <>
      ...
      <DepressionTreatmentPage config={config} />
    </>
  );
}
