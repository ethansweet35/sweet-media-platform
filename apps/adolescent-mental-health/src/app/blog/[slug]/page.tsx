...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://adolescentmentalhealth.com";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `${titleBase} | Adolescent Mental Health`;
  const description =
    metaString(row?.meta_description).trim() ||
    metaString(row?.excerpt).trim() ||
    "Mental health, addiction recovery, and trauma-informed care resources from Adolescent Mental Health.";
  ...
  return {
    ...
    openGraph: {
      ...
      title,
      description,
      siteName: "Adolescent Mental Health",
