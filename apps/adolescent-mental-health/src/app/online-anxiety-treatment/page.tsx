...
import AnxietyTreatmentPage from "@/views/treatment/AnxietyTreatmentPage";

const config = TREATMENT_LANDING_PAGES["/online-anxiety-treatment"];
...
export default function Page() {
  return (
    <>
      ...
      <AnxietyTreatmentPage config={config} />
    </>
  );
}
