...
import AdhdTreatmentPage from "@/views/treatment/AdhdTreatmentPage";

const config = TREATMENT_LANDING_PAGES["/adhd-treatment-for-teens"];
...
export default function Page() {
  return (
    <>
      ...
      <AdhdTreatmentPage config={config} />
    </>
  );
}
