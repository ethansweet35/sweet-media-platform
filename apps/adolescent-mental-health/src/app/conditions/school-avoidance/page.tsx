...
import SchoolAvoidanceTreatmentPage from "@/views/treatment/SchoolAvoidanceTreatmentPage";

const config = CONDITION_TREATMENT_PAGES["/conditions/school-avoidance"];
...
export default function Page() {
  return (
    <>
      ...
      <SchoolAvoidanceTreatmentPage config={config} />
    </>
  );
}
