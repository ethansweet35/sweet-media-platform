      ...
      <section className="relative overflow-hidden bg-[#3a6697]">
        <div className="absolute inset-0">
          <Image
            ...
            alt="The Grove campus — men's residential treatment at Northbound in Garden Grove"
            fill
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 lg:items-center">
            ...
            <div className="relative">
              <div className="relative aspect-[4/3] overflow-hidden">
                <Image
                  src={SERVICE_IMAGES.outdoorCircle}
                  alt="Outdoor reflection circle at The Grove — men's residential community at Northbound"
                  fill
