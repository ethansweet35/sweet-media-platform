...
const FAQS = [
  ...
  },
  {
    ...
    a: "Treatment length varies based on individual need and the level of care required. We offer a full continuum — from medical detox through residential, PHP, virtual IOP, and aftercare — allowing us to step you up or down based on progress. Many clients complete a 30, 60, or 90-day program.",
  },
  {
