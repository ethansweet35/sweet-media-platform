        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-20 pt-32 lg:px-10">
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link
                href="tel:8663110003"
                className="inline-flex items-center gap-2 rounded-full bg-[#E8622A] px-7 py-3.5 text-sm font-semibold text-white shadow-lg transition hover:bg-[#d4531d]"
              >
                <i className="ri-phone-fill"></i>
                Call (866) 311-0003
              </Link>
              <Link
                href="/admissions/insurance-coverage/"
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 rounded-2xl bg-[#0B1F3A] px-6 py-5 shadow-xl">
                ...
                <p className="mt-0.5 text-xs font-semibold uppercase tracking-widest text-[#E8622A]">Bed Capacity</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {programs.map((p, i) => (
              <div
                key={p.name}
                className={`relative rounded-3xl p-8 ${i === 0 ? "bg-[#0B1F3A] text-white lg:col-span-1" : "bg-white ring-1 ring-[#E5E7EB]"}`}
              >
                <div
                  className={`mb-4 flex h-12 w-12 items-center justify-center rounded-2xl ${i === 0 ? "bg-[#E8622A]/20" : "bg-[#F5F7FF]"}`}
                >
          ...
          <p className="mt-8 text-center text-sm text-[#6B7280]">
            ...
            <Link href="tel:8663110003" className="font-semibold text-[#0B1F3A] underline-offset-4 hover:underline">
              ...
              <div className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2">
                {activities.map((a) => (
                  <div key={a} className="flex items-center gap-3">
                    <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#E8622A]/10 text-[#E8622A]">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="grid gap-14 lg:grid-cols-[1fr_2fr] lg:items-start">
            <div>
              ...
              <Link
                href="tel:8663110003"
                className="mt-8 inline-flex items-center gap-2 rounded-full bg-[#E8622A] px-7 py-3.5 text-sm font-semibold text-white transition hover:bg-[#d4531d]"
              >
                <i className="ri-phone-fill"></i>
                (866) 311-0003
              </Link>
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
              {therapyServices.map((s) => (
                ...
                >
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#E8622A]/20 text-[#E8622A]">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="mb-12 text-center">
            ...
            <div className="mt-4 flex items-center justify-center gap-1">
              {Array.from({ length: 5 }).map((_, i) => (
                <i key={i} className="ri-star-fill text-[#E8622A] text-lg"></i>
              ))}
              <span className="ml-2 text-sm text-[#6B7280]">4.6/5 · 224+ Google Reviews</span>
            </div>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div key={t.name} className="rounded-3xl bg-white p-7 shadow-sm ring-1 ring-[#E5E7EB]">
                <div className="flex gap-0.5 mb-4">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <i key={i} className="ri-star-fill text-[#E8622A] text-sm"></i>
                  ))}
                </div>
      ...
      <section className="bg-[#F5F7FF] py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              href="/admissions/insurance-coverage/"
              className="inline-flex items-center gap-2 rounded-full bg-[#0B1F3A] px-7 py-3.5 text-sm font-semibold text-white transition hover:bg-[#16305e]"
            >
              Verify My Insurance
            </Link>
            <Link
              href="tel:8663110003"
              className="inline-flex items-center gap-2 rounded-full border border-[#0B1F3A]/20 px-7 py-3.5 text-sm font-semibold text-[#0B1F3A] transition hover:border-[#0B1F3A]/50"
            >
