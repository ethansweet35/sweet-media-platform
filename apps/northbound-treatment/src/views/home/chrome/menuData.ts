    ...
    sections: [
      {
        ...
        links: [
          ...
          { label: "Men's Residential", href: "/programs/residential-treatment-center/mens-residential-treatment/", icon: "ri-men-line" },
          { label: "Women's Residential", href: "/programs/residential-treatment-center/womens-residential-treatment/", icon: "ri-women-line" },
          { label: "Partial Hospitalization (PHP)", href: "/programs/partial-hospitalization-program/", icon: "ri-hospital-line" },
          { label: "Intensive Outpatient (IOP)", href: "/programs/intensive-outpatient-treatment/", icon: "ri-calendar-check-line" },
          { label: "Transitional Living", href: "/treatment/transitional-living-programs/", icon: "ri-building-2-line" },
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Veterans Track Program", href: "/veterans-track-program/", icon: "ri-shield-star-line" },
    ...
    sections: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Men's Residential", href: "/programs/residential-treatment-center/mens-residential-treatment/", icon: "ri-men-line" },
          { label: "Women's Residential", href: "/programs/residential-treatment-center/womens-residential-treatment/", icon: "ri-women-line" },
          { label: "Transitional Living", href: "/treatment/transitional-living-programs/", icon: "ri-door-open-line" },
          { label: "Telehealth / Online IOP", href: "/telehealth-iop-services/", icon: "ri-wifi-line" },
        ],
      },
    ],
  },
