      ...
      <section className="bg-[#1b2a47] py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-white/70">
            Northbound Treatment Center is a leading drug and alcohol addiction treatment center
            dedicated to transforming the lives of people struggling with addiction and co-occurring
            mental health disorders — since 1988.
          </p>
          ...
          <div className="grid gap-16 lg:grid-cols-2 items-center">
            <div>
              ...
              <p className="text-sm leading-7 text-[#64748b] mb-4">
                Northbound was initially founded in 1988 under the name National Therapeutic Services
                ...
                into a nationally recognized treatment provider.
              </p>
              <p className="text-sm leading-7 text-[#64748b] mb-4">
                Along with senior management, Alexander began rebranding NTS around a culture of
              ...
              <p className="text-sm leading-7 text-[#64748b]">
                As leadership discussed this new direction, there was a reference to the Northbound
                train and the positive connotations of &ldquo;heading north.&rdquo; The organization&apos;s
                new name — Northbound — emerged.
              </p>
            </div>
      ...
      <section className="py-20 bg-[#1b2a47]">
        <div className="mx-auto max-w-5xl px-6 lg:px-10 text-center">
          ...
          <p className="mt-6 text-white/70 leading-7 max-w-3xl mx-auto">
            We believe that change is possible. We know firsthand that while in the depths of addiction,
            embarking on recovery can feel overwhelming. We also know that not all treatment programs are
            created equal — and that the right environment and support are critical to achieving lifelong recovery.
          </p>
          <div className="mt-10 grid grid-cols-2 sm:grid-cols-4 gap-px bg-white/10">
            {[
              ...
              <div key={s.label} className="bg-[#1b2a47] py-8 px-4">
                ...
                <p className="mt-1 text-xs font-semibold uppercase tracking-[0.1em] text-white/60">{s.label}</p>
              </div>
            ))}
          </div>
        </div>
                ...
                {philosophyPoints.map((p) => (
                  <div key={p.title} className="flex items-start gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-7 text-[#64748b]">{p.body}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="grid gap-px bg-[#cdd8e8] sm:grid-cols-2 lg:grid-cols-3">
            {subPages.map((p) => (
              <Link key={p.label} href={p.href} className="group bg-white p-8 flex flex-col gap-3 hover:bg-[#eef2f7] transition-colors">
                ...
                <p className="text-sm leading-6 text-[#64748b] flex-1">{p.desc}</p>
      ...
      <section className="bg-[#1b2a47] py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="mt-3 text-white/70">Our admissions team is available 24/7 — confidential and free.</p>
          </div>
