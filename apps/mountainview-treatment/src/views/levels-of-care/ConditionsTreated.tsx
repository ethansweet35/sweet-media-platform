...
export type ConditionsTreatedProps = {
    ...
    <section className="bg-[var(--mvt-cream)] text-[var(--mvt-ink)]">
      <div className="mx-auto max-w-[1280px] px-6 py-20 lg:px-12 lg:py-24">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2 lg:gap-8">
          <ConditionList title="Substance Use Disorders" icon="ri-capsule-line" items={SUBSTANCE} />
          <ConditionList title="Mental Health Disorders" icon="ri-mental-health-line" items={MENTAL} />
        </div>
      </div>
    </section>
  );
