export type TherapyUnderstandingProps = {
  eyebrow: string;
...
export default function TherapyUnderstanding({
  eyebrow,
  headline,
  intro,
  leftCard,
  rightCard,
}: TherapyUnderstandingProps) {
  return (
      ...
      <div className="mx-auto max-w-[1280px] px-6 py-20 lg:px-12 lg:py-24">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2 lg:gap-8">
          ...
          <article className="bg-[var(--mvt-forest-deep)] p-10 text-white shadow-sm">
            ...
            {rightCard.intro && (
              <p className="mt-6 text-[15px] leading-7 text-white/80">{rightCard.intro}</p>
            )}
            <ul className="mt-6 grid gap-3">
              {rightCard.bullets.map((b) => (
