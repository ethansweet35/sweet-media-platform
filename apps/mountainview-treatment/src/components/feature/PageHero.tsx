 ...
 * Compact banner height (vs. homepage's full-bleed hero).
 */
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[var(--mvt-ink)] text-white">
      ...
      <div className="mx-auto max-w-[1280px] px-6 pb-16 pt-16 sm:pb-20 sm:pt-20 lg:px-12 lg:pb-24 lg:pt-24">
        ...
        <h1 className="mt-6 max-w-3xl font-heading text-[44px] leading-[1.06] tracking-tight text-white sm:text-5xl lg:text-[64px]">
          {headline}
        </h1>
        {body && (
          <p className="mt-6 max-w-3xl text-base leading-7 text-white/85 sm:text-[17px]">
            {body}
          </p>
        )}
      </div>
