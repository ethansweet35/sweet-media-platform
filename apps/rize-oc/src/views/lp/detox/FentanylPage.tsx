...
const fentanylConditions = {
  substance: [
    ...
    { name: "Benzodiazepine Dependence", body: "Safe, medically-monitored tapering and therapeutic intervention." },
  ...
  mentalHealth: [
    ...
    { name: "Anxiety Disorders", body: "Specialized care for generalized anxiety, panic disorders, and the severe psychological distress often triggered by fentanyl withdrawal." },
...
const fentanylLevels = [
  { num: "01", intensity: "Most Intensive · 3–10 Days", title: "Medical Detox", body: "The vital first step. A 24/7 medically-assisted protocol designed to safely manage severe fentanyl withdrawal symptoms using FDA-approved comfort medications. Prioritizing your immediate safety and relief." },
  { num: "02", intensity: "High Intensive · 30–90 Days", title: "Residential (RTC)", body: "Once physically stabilized from fentanyl, engage in deep, immersive therapy in our coastal sanctuary. Step away from daily triggers to heal the psychological toll of opioid dependency and trauma." },
  { num: "03", intensity: "Medium Intensive · 2–4 Weeks", title: "PHP", body: "Robust daytime clinical programming to help you navigate early recovery from synthetic opioids. Provides structure and support while allowing you to practice emotional regulation in the evenings." },
  { num: "04", intensity: "Least Intensive · 8–12 Weeks", title: "IOP", body: "The gentle return. Flexible, targeted therapeutic check-ins to safeguard your sobriety from fentanyl and support your successful integration back into career, family, and community." },
];
...
export default function FentanylPage() {
  return (
    <LpShell>
      <LpHero
        headline="Specialized Fentanyl Detox & Withdrawal Treatment"
        subheadline="Safely and comfortably overcome fentanyl withdrawal with our private, medically-assisted detox program. Covered by most major insurances."
        eyebrow="1,000+ Successful Recoveries · 139+ 5-Star Reviews"
        stat="24/7"
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-[1300px] px-6">
          <div className="grid lg:grid-cols-[1fr_380px] gap-16 items-center">
            <div>
              <p className="text-[10px] font-medium uppercase tracking-[0.35em] text-accent mb-4">Expert Medical Detox</p>
              <h2
                className="font-[family-name:var(--font-display)] font-normal text-ink mb-6"
                style={{ fontSize: "clamp(28px, 3vw, 44px)", lineHeight: 1.1 }}
              >
                Specialized Treatment For Fentanyl Withdrawals
              </h2>
              <p className="text-base font-light leading-relaxed text-ink/70 mb-4">
                Fentanyl withdrawal can feel overwhelming, but you do not have to face it alone. At Rize, our clinical team specializes in medically supervised detox protocols specifically designed for synthetic opioids. We utilize 24/7 monitoring and FDA-approved comfort medications to minimize your physical withdrawal symptoms and keep you safe.
              </p>
              <p className="text-base font-light leading-relaxed text-ink/70 mb-6">
                Located in a private, serene setting in Orange County, we provide the expert medical foundation you need to comfortably start your recovery.
              </p>
              <a
                href={PHONE_HREF}
      ...
      <section className="bg-[#F8F6F3] py-20">
        <div className="mx-auto max-w-[1300px] px-6">
          <div className="mb-12 text-center">
            <p className="text-[10px] font-medium uppercase tracking-[0.35em] text-accent mb-3">Specialized Fentanyl Detox Care</p>
            <h2
              className="font-[family-name:var(--font-display)] font-normal text-ink"
              style={{ fontSize: "clamp(30px, 3.5vw, 48px)", lineHeight: 1.1 }}
            >
              Personalized Detox & Treatment Programs
            </h2>
            <p className="mt-4 max-w-xl mx-auto text-sm font-light text-ink/60">
              Evidence-based, medically supervised treatment to safely manage fentanyl withdrawal and co-occurring mental health needs.
            </p>
          </div>
          <div className="grid gap-8 lg:grid-cols-2">
            <div>
              ...
              <div className="grid gap-4">
                {fentanylConditions.substance.map((c) => (
            ...
            <div>
              ...
              <div className="grid gap-4">
                {fentanylConditions.mentalHealth.map((c) => (
                  <div key={c.name} className="bg-white border border-warm/40 p-5">
                    <p className="font-medium text-ink mb-1">{c.name}</p>
                    <p className="text-sm font-light leading-relaxed text-ink/65">{c.body}</p>
                  </div>
              ...
              <div className="mt-6 border-l-2 border-accent pl-5">
                <p className="text-sm font-light leading-relaxed text-ink/70">
                  Fentanyl addiction is heavily linked to underlying anxiety, depression, and trauma. Our integrated dual-diagnosis approach treats the intense psychological symptoms of withdrawal while addressing the root causes of your dependency.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-[1300px] px-6">
          <div className="mb-12 text-center">
            ...
            <h2
              ...
              style={{ fontSize: "clamp(30px, 3.5vw, 48px)", lineHeight: 1.1 }}
            >
              Your Path Through Fentanyl Recovery
            </h2>
          </div>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {fentanylLevels.map((level) => (
