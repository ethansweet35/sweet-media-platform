    ...
    <main className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-[#3E5B50] py-24">
        ...
        <div className={`relative ${CONTAINER}`}>
          <div className="mx-auto mb-14 max-w-2xl text-center">
            <p className="brand-eyebrow mb-4 text-[#8FAC87]">Why Treatment Keeps Failing</p>
      ...
      <section className="relative h-[420px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 p-10 text-white">
          ...
          <p className="mt-2 text-sm text-white/70">— Family of a young woman now stable in integrated recovery</p>
        </div>
      </section>
