...
const TEENS_FAQS: Faq[] = [
  ...
  },
  {
    ...
    answer: "We prepare families for this possibility during the coaching phase. We also work with programmes that have experience with resistant teens and can coordinate with educational consultants or therapeutic transport when clinically appropriate and legally supported.",
  },
];
  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="font-heading mb-6 text-4xl font-bold leading-tight text-[#1A1A17] md:text-5xl">
                What a professional teen intervention <span className="italic text-[#507969]">actually looks like</span>
              </h2>
              ...
              <p className="text-base leading-relaxed text-[#4B4B4B]">
                We never escalate or shame. The intervention is structured to preserve the relationship while creating clear expectations and immediate access to the right level of care — whether that is therapeutic boarding school, wilderness therapy, residential treatment, or intensive outpatient with strong family involvement.
              </p>
            </div>
      ...
      <section className="relative h-[420px] overflow-hidden">
        <Image src={FAMILY_IMG} alt="A family supporting their teenager" fill className="object-cover" />
