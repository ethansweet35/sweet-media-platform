          ...
          <div className="grid items-center gap-14 lg:grid-cols-[1fr_460px]">
            <div>
              ...
              <p className="mb-8 max-w-lg text-base leading-relaxed text-white/80 md:text-lg">
                High-functioning professionals require a different level of discretion, planning, and placement. We have helped CEOs, surgeons, attorneys, and leaders get well — without their careers collapsing in the process.
              </p>
      ...
      <section className="bg-white py-24">
        <div className={CONTAINER}>
          <div className="grid gap-16 lg:grid-cols-2 lg:items-start">
            <div>
              <p className="brand-eyebrow mb-4 text-[#8FAC87]">Recognising the Problem</p>
              ...
              <p className="mb-8 text-base leading-relaxed text-[#4B4B4B]">
                High-functioning addiction is one of the most dangerous forms because the external performance masks internal collapse. If several of these are true, the problem is further along than it appears.
              </p>
      ...
      <section className="relative overflow-hidden bg-[#3E5B50] py-24">
        ...
        <div className={`relative ${CONTAINER}`}>
          <div className="mx-auto mb-14 max-w-2xl text-center">
            <p className="brand-eyebrow mb-4 text-[#8FAC87]">Why Families Hesitate</p>
