...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = `${titleBase} | Addiction Interventions`;
  const description =
    metaString(row?.meta_description).trim() ||
    metaString(row?.excerpt).trim() ||
    "Mental health, addiction recovery, and trauma-informed care resources from Addiction Interventions.";
  ...
  return {
    ...
    openGraph: {
      ...
      title,
      description,
      siteName: "Addiction Interventions",
