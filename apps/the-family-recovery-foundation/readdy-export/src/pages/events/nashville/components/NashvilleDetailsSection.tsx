...
export default function NashvilleDetailsSection() {
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-soft-white rounded-xl p-5 border border-mist/60">
                ...
                <p className="text-body-m font-body font-medium text-deep-navy">Thursday, November 5, 2026</p>
              </div>
              ...
              <div className="bg-soft-white rounded-xl p-5 border border-mist/60">
                ...
                <p className="text-body-m font-body font-medium text-deep-navy">5:30pm Doors Open</p>
              </div>
              ...
              <div className="bg-soft-white rounded-xl p-5 border border-mist/60 sm:col-span-2">
                ...
                <p className="text-body-m font-body font-medium text-deep-navy">Copperline Ranch</p>
                <p className="text-body-s font-body text-slate">1 Copperline Rd, Heritage, TN 37076</p>
              </div>
            </div>
            ...
            <div className="bg-soft-white rounded-2xl p-6 md:p-8 border border-mist/60">
              ...
              <div
                className={cn(
                  ...
                  readMoreOpen ? "max-h-[600px]" : "max-h-[110px]"
                )}
              >
                ...
                {readMoreOpen && (
                  <>
                    <p className="text-body-s font-body text-slate leading-relaxed mt-4">
                      Through testimonial storytelling and shared vision, the gala raises
                      awareness of the often unseen struggles families face while generating
                      the financial support needed to expand our free, clinically-guided family
                      programs across the United States.
                    </p>
                    <p className="text-body-s font-body text-slate leading-relaxed mt-4">
                      When you attend, sponsor, or support this event, you are doing more than
                      joining an evening of purpose — you are actively helping families heal.
                      Every seat filled, every partnership formed, and every dollar raised helps
                      ensure that no family walks this journey alone.
                    </p>
                  </>
                )}
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="flex items-center justify-between py-3 border-b border-pure-white/15">
                      ...
                      <p className="text-body-l font-display text-[#C9A44A] font-medium">$85</p>
                    </div>
                    <div className="flex items-center justify-between py-3 border-b border-pure-white/15">
                      <div>
                      ...
                      <p className="text-body-l font-display text-[#C9A44A] font-medium">$650</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 mb-8">
                    ...
                    <p className="text-caption font-body text-pure-white/60 leading-relaxed">
                      Dinner served at 6:00pm. All proceeds support families affected by addiction and mental health challenges.
                    </p>
                  </div>
                </div>

                <a
                  href="https://donorbox.org/events/912420/steps/choose_tickets"
                  target="_blank"
