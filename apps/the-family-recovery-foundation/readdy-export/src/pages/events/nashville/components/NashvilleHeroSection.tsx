    ...
    <section className="relative bg-soft-white pt-24 md:pt-28 lg:pt-32 pb-12 md:pb-16 overflow-hidden">
      ...
      <div className="max-w-bleed mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="relative rounded-2xl overflow-hidden">
          <img
            src="https://readdy.ai/api/search-image?query=Nashville%20Tennessee%20skyline%20panoramic%20view%20at%20golden%20hour%20sunset%20with%20warm%20amber%20light%20reflecting%20off%20modern%20downtown%20buildings%20and%20the%20Cumberland%20River%2C%20dramatic%20cloud%20formations%2C%20cinematic%20wide%20angle%20photography%2C%20deep%20blue%20and%20warm%20gold%20color%20palette%2C%20elegant%20event%20venue%20atmosphere%2C%20no%20text%20overlay%2C%20clean%20simple%20sky%20background&width=1200&height=500&seq=nashville-hero-001&orientation=landscape"
