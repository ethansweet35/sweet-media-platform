...
const eventsDropdownItems = [
  { label: "Annual Gala", href: "/events" },
  { label: "Nashville Gala", href: "/events/nashville" },
];

const socialLinks = [
  { icon: "ri-youtube-fill", href: "https://youtube.com", label: "YouTube", color: "text-red-600" },
  { icon: "ri-tiktok-fill", href: "https://tiktok.com", label: "TikTok", color: "text-deep-navy" },
  { icon: "ri-instagram-line", href: "https://instagram.com", label: "Instagram", color: "text-deep-navy" },
  { icon: "ri-facebook-fill", href: "https://facebook.com", label: "Facebook", color: "text-deep-navy" },
];
      ...
      <header
        className={cn(
          ...
          scrolled
            ...
            : "bg-pure-white/80 backdrop-blur-sm border border-pure-white/30"
        )}
      >
                    ...
                    <>
                      <button
                        ...
                        className={cn(
                          ...
                          (item.label === "About" && aboutOpen) || (item.label === "Our Services" && servicesOpen) || (item.label === "Events" && eventsOpen)
                            ? "text-tfrf-blue"
                      ...
                      >
                        ...
                        <i className={cn(
                          ...
                          (item.label === "About" && aboutOpen) || (item.label === "Our Services" && servicesOpen) || (item.label === "Events" && eventsOpen) && "rotate-180"
                        )} />
                      </button>
