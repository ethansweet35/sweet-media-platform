...
const sponsorTiers: SponsorTier[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Table placement priority",
      "Featured in pre-event communications",
    ],
  },
  {
    ...
    details: [
      ...
      "8 complimentary gala tickets",
      "Reserved premium table",
      "Speaking opportunity during event",
      "Post-event recognition video",
    ],
  },
  {
    name: "Legacy Sponsor",
    ...
    details: [
      ...
      "10 complimentary gala tickets",
      "Private reception with leadership",
      "Year-long website feature",
