...
export function parseMarkdownPost(md: string): ParsedBlogPost {
  ...
  return {
    ...
    author: frontmatter.author || "The Family Recovery Foundation",
    authorRole: frontmatter.authorRole || "Editorial Team",
    authorBio: frontmatter.authorBio || "Helpful educational resources from The Family Recovery Foundation.",
