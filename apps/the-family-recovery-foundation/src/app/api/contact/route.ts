...
const BRAND_NAME = process.env.CONTACT_BRAND_NAME ?? 'The Family Recovery Foundation';
...
const TO = process.env.CONTACT_TO_EMAIL ?? 'info@tfrfoundation.org';
...
function buildHtml(fields: Record<string, string | undefined>) {
  const rows = [
    row('Form', fields.form_type),
    row('Name', fields.name),
    row('Email', fields.email),
    row('Phone', fields.phone),
    row('Seeking Help For', fields.seeking_help_for),
    row('How Found Us', fields.how_found ?? fields.hearAbout),
...
function buildText(fields: Record<string, string | undefined>) {
  return [
    ...
    ``,
    fields.form_type  && `Form:     ${fields.form_type}`,
    fields.name       && `Name:     ${fields.name}`,
    fields.email      && `Email:    ${fields.email}`,
    fields.phone      && `Phone:    ${fields.phone}`,
    fields.seeking_help_for && `Seeking help for: ${fields.seeking_help_for}`,
    (fields.how_found ?? fields.hearAbout) && `How found: ${fields.how_found ?? fields.hearAbout}`,
