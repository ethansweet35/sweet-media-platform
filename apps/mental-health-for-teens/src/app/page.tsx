...
const IMAGES = {
  hero: 'https://awalaktpqqwpdvzbafkv.supabase.co/storage/v1/object/public/site-assets/images/mhft-hero.png',
  ...
  parents: 'https://awalaktpqqwpdvzbafkv.supabase.co/storage/v1/object/public/site-assets/images/mhft-parents.png',
} as const;
    ...
    <main className="overflow-x-hidden">
      <section className="relative isolate min-h-screen pt-32 pb-16 md:pt-40">
        <div className="absolute inset-0 -z-20">
          <Image src={IMAGES.hero} alt="Teen and caregiver with clinician in a calming treatment environment" fill priority className="object-cover" />
          <div className="absolute inset-0 bg-[linear-gradient(100deg,rgba(13,17,28,0.84)_0%,rgba(17,17,17,0.62)_42%,rgba(17,17,17,0.18)_100%)]" />
        </div>
        <div className="absolute inset-0 -z-10 ambient-gradient-subtle opacity-70" />
        <div className="absolute inset-0 -z-10 premium-grain opacity-20" />

        <div className="mx-auto grid w-full max-w-7xl gap-8 px-6 md:px-10 xl:grid-cols-[1.05fr_0.95fr] xl:items-end xl:px-14">
          <div className="flex flex-col gap-8">
          <div className="inline-flex w-fit items-center gap-2 rounded-full border border-canvas-white/20 bg-canvas-white/10 px-4 py-2 backdrop-blur-sm">
            <DuotoneIcon name="spark" />
            <span className="text-[11px] font-medium uppercase tracking-[0.24em] text-canvas-white/80">Caregiver-First Teen Mental Health</span>
          </div>
          ...
          <div className="max-w-3xl space-y-6">
            <h1 className="text-balance text-canvas-white text-[clamp(2.2rem,5.4vw,4.8rem)] font-semibold leading-[1.03] tracking-[-0.03em]">
              Premium Teen Mental Health Care
              <br />
              <span className="bg-[linear-gradient(120deg,#ffd7f0_0%,#e2ddfd_45%,#99fff9_100%)] bg-clip-text text-transparent">With Clarity for Families.</span>
            </h1>
            <p className="max-w-2xl text-pretty text-[15px] leading-7 text-canvas-white/80 md:text-[17px] md:leading-8">
              Compassionate outpatient support for teens ages 12-18, delivered by licensed clinicians. We make the process clear, coordinate insurance, and help
          ...
          <article className="glass-luxe hidden rounded-[26px] p-6 text-canvas-white xl:block">
            <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-canvas-white/70">Family Intake Signature</p>
            <h2 className="text-2xl font-semibold leading-tight tracking-[-0.02em]">From first call to first session in days.</h2>
            <p className="mt-4 text-[15px] leading-7 text-canvas-white/82">
              A concierge-style admissions process built for overwhelmed families: clear guidance, fast verification, and immediate next steps.
            </p>
      ...
      <section className="border-y border-black/5 bg-whisper-gray/55 py-5">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-x-8 gap-y-2 px-6 md:px-10 xl:px-14">
          {['Evidence-Based Treatment', 'Family-Centered Approach', 'Local Colorado Team', 'Private and Confidential'].map((item) => (
      ...
      <section className="bg-[linear-gradient(180deg,#ffffff_0%,#fbfbfb_100%)] py-20 md:py-24">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 md:px-10 xl:grid-cols-[1fr_1.08fr] xl:items-center xl:px-14">
          ...
          <div className="relative h-[540px] overflow-hidden rounded-[30px] border border-black/7 bg-whisper-gray">
            <Image src={IMAGES.services} alt="Teen outpatient therapy session and supportive family consultation" fill className="object-cover" sizes="(max-width: 1280px) 100vw, 50vw" />
      ...
      <section className="bg-whisper-gray/55 py-20 md:py-24">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 md:px-10 lg:grid-cols-[1fr_1.05fr] xl:px-14">
          <div className="relative min-h-[280px] overflow-hidden rounded-[28px] border border-black/8 lg:min-h-full">
            <Image src={IMAGES.parents} alt="Parent and teen in a warm, supportive counseling environment" fill className="object-cover" sizes="(max-width: 1280px) 100vw, 46vw" />
            <SoftTexture className="absolute inset-0" />
          </div>
          <div>
      ...
      <section className="relative overflow-hidden py-20 md:py-24">
        <div className="absolute inset-0 ambient-gradient opacity-50" aria-hidden />
