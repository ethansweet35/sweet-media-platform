...
const processSteps = [
  {
    num: "01",
    label: "Onboard",
    title: "SUD-specific onboarding",
    focus: "Audit-ready before your first substance abuse claim hits the payer.",
    summary: "We review your billing needs before SUD treatment claims go live—not after denials pile up.",
    details: [
      "HCPCS/CPT crosswalk for detox, residential, PHP, and outpatient",
      "HIPAA workflows and patient data handling review",
      "Insurance verification and auth templates by level of care",
    ],
  },
  {
    num: "02",
    label: "Manage",
    title: "Daily billing operations",
    focus: "Claim submission and UR stay aligned to your census.",
    summary: "Cipher handles billing processes while treatment providers focus on patient care.",
    details: [
      "Verify insurance and re-check benefits on LOC changes",
      "Pre-bill validation on every abuse billing claim",
      "Concurrent review support for residential and outpatient programs",
    ],
  },
  {
    num: "03",
    ...
    focus: "Denials, reporting, and payer updates without losing momentum.",
    summary: "We improve operational efficiency as your programs and payer rules evolve.",
    details: [
      "Denial trend analysis with root-cause fixes",
      "State regulation and commercial policy updates",
      "A/R follow-up and appeals on substance use disorder claims",
    ],
  },
] as const;

export default function SubstanceAbuseProcess() {
  return (
    <section id="substance-abuse-process" className={`bg-[#F5F7FA] ${LANDING_SECTION_PY}`}>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-14">
          <div className="lg:self-center">
            ...
            <h2 className="mt-4 font-[var(--font-heading)] text-[1.75rem] font-medium leading-tight text-[#101E3F] md:text-[2rem]">
              How Cipher delivers <span className="text-[#166C96]">substance abuse billing services</span>
            </h2>
            <p className="mt-3 text-[15px] leading-[1.6] text-slate-600">
              Onboard → Manage → Optimize. Our engagement model for addiction treatment revenue cycle management—not a
              one-time setup for billing systems you still have to run alone.
            </p>
            <p className="mt-4 text-[14px] leading-[1.6] text-slate-600">
              Cipher&apos;s services help treatment centers reduce administrative tasks, improve accurate billing, and keep
              financial health stable when mental health and SUD programs share the same census.
            </p>
