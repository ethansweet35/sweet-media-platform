...
const trustBullets = [
  "Substance use disorder billing for detox, residential, PHP, and outpatient programs",
  "Insurance verification and prior auth before patients admit to your center",
  "HIPAA-aligned billing processes—co-occurring mental health and SUD on one team",
  ...cipherHomeMetricBullets.slice(0, 2),
] as const;

export default function SubstanceAbuseLandingHero() {
  return (
    <section className={`relative overflow-hidden bg-[#101E3F] ${LANDING_SECTION_PY}`}>
      <div className="absolute inset-0">
        <Image
          src={SUBSTANCE_ABUSE_LANDING_IMAGES.hero}
          alt="Addiction treatment center for substance abuse billing and revenue cycle management services"
          fill
          priority
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)] lg:items-center lg:gap-14">
          <div className="max-w-xl">
            <div className="flex items-center gap-3">
              ...
              <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-[#5eb5e0]">
                Addiction &amp; co-occurring mental health billing
              </p>
            </div>
            ...
            <h1 className="mt-5 font-[var(--font-heading)] text-4xl font-medium leading-[1.08] tracking-[-0.02em] text-white md:text-5xl lg:text-[3.25rem]">
              Substance abuse billing services that{" "}
              <span className="text-[#5eb5e0]">strengthen cash flow</span>
            </h1>

            <p className="mt-6 text-[15px] leading-[1.75] text-white/85 md:text-base">
              Cipher&apos;s substance abuse billing services help addiction treatment centers and behavioral health
              programs bill SUD treatment with clean claims—detox, residential, intensive outpatient, and outpatient
              substance use disorder services—so your team is not buried in claim denials and verification delays.
            </p>
          ...
          >
            ...
            <h2 className="mt-2 font-[var(--font-heading)] text-2xl font-medium leading-snug text-white md:text-[1.65rem]">
              Request your SUD billing review
            </h2>
            <p className="mt-2 text-[13px] leading-relaxed text-white/55">
              Tell us about your treatment center or health clinics. We&apos;ll review your substance abuse billing setup
              against payer rules—so you see where abuse billing gaps may be costing collections.
            </p>
            <div className="mt-6">
              <ServiceLandingLeadForm programLabel="Substance Abuse Billing Services" />
            </div>
          </div>
        </div>
      </div>
