...
const proofColumns = [
  ...
  {
    stat: "Clean",
    statLabel: "claims focus",
    challenge: "Coding accuracy",
    challengeBody:
    ...
    solution:
      "Certified billing coding on every claim—CPT codes, modifiers, and ICD-10 pairs reviewed against payer contracts for your size practice.",
  ...
  },
  {
    ...
    challengeBody:
      "Therapy claim denials tied to documentation or authorization are recoverable when appealed with the right clinical context—not routine write-offs.",
    solution:
      "Proactive denial management and appeal strategies tuned to mental health and behavioral health payers—services support that improves your bottom line.",
    icon: "ri-loop-left-line",
  },
] as const;

export default function MentalHealthDifferentiation() {
  return (
      ...
      <div className={SERVICE_CONTAINER}>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-[15px] leading-[1.65] text-slate-600">
            The best mental health billing services combine healthcare billing expertise with customer service your
            practice can reach—Cipher delivers full-service billing with a revenue cycle strategy built for therapists,
            prescribers, and integrated programs.
          </p>
        </div>
