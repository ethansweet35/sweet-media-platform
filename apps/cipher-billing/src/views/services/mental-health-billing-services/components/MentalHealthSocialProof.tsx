...
export default function MentalHealthSocialProof() {
  return (
      ...
      <div className={SERVICE_CONTAINER}>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 font-[var(--font-heading)] text-[1.75rem] font-medium leading-tight md:text-[2.125rem]">
            Trusted for <span className="text-[#5eb5e0]">mental health billing services</span>
          </h2>
          <p className="mt-4 text-[14px] leading-[1.65] text-white/70">
            Same benchmarks we publish on our homepage for behavioral health practices—including a 9-minute average
