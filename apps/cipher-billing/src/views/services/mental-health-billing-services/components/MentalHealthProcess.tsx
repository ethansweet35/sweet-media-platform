...
const processSteps = [
  {
    num: "01",
    label: "Onboard",
    title: "Practice-specific onboarding",
    focus: "Clean claims from day one—not a generic billing handoff.",
    summary: "We audit CPT setup, credentialing status, and payer contracts before claims processing scales.",
    details: [
      "CPT and modifier crosswalk for your provider mix",
      "EHR or EMR charge capture alignment",
      "Credentialing and panel enrollment checklist",
    ],
  },
  {
    num: "02",
    ...
    focus: "Claim submission and payment posting aligned to your schedule.",
    summary: "Cipher handles insurance billing while clinicians focus on patient care.",
    details: [
  ...
  },
  {
    ...
    focus: "Denial trends, reporting, and payer updates.",
    summary: "We help practice management improve operational efficiency over time.",
    details: [
...
export default function MentalHealthProcess() {
  return (
    <section id="mental-health-process" className={`bg-[#F5F7FA] ${LANDING_SECTION_PY}`}>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-14">
          <div className="lg:self-center">
            ...
            <h2 className="mt-4 font-[var(--font-heading)] text-[1.75rem] font-medium leading-tight text-[#101E3F] md:text-[2rem]">
              How Cipher delivers <span className="text-[#166C96]">mental health billing services</span>
            </h2>
            <p className="mt-3 text-[15px] leading-[1.6] text-slate-600">
              Onboard → Manage → Optimize. Cycle management RCM for mental health practices—not a one-size template from
              billing companies that treat therapy as generic healthcare billing.
            </p>
            <p className="mt-4 text-[14px] leading-[1.6] text-slate-600">
              Services across solo therapists, group practices, and health specialists—including programs that also bill
