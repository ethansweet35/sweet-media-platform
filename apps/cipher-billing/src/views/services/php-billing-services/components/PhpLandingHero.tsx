...
const IMG_HERO = PHP_LANDING_IMAGES.hero;

const trustBullets = [
  "Medicare coverage for partial hospitalization programs",
  "Per diem HCPCS (S0201, H0015, H0035) and revenue code 0912 on your PHP census",
  "Day-eighteen recertification, auth, and PHP-to-IOP step-down overlap prevention",
  ...cipherHomeMetricBullets.slice(0, 2),
] as const;

export default function PhpLandingHero() {
  return (
    <section className={`relative overflow-hidden bg-[#101E3F] ${LANDING_SECTION_PY}`}>
      <div className="absolute inset-0">
        <Image
          src={IMG_HERO}
          alt="Behavioral health team coordinating partial hospitalization program billing for mental health and substance use treatment"
          fill
          priority
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)] lg:items-center lg:gap-14">
          ...
          >
            ...
            <h2 className="mt-2 font-[var(--font-heading)] text-2xl font-medium leading-snug text-white md:text-[1.65rem]">
              Request your PHP billing review
            </h2>
            <p className="mt-2 text-[13px] leading-relaxed text-white/55">
              Tell us about your partial hospitalization program. We&apos;ll review your PHP billing setup and PHP billing
              requirements
              against payer rules—so you see where claims or documentation may be leaving money on the table.
            </p>
            <div className="mt-6">
              <ServiceLandingLeadForm programLabel="PHP Billing Services" />
            </div>
          </div>
        </div>
      </div>
