...
const processSteps = [
  {
    num: "01",
    label: "Onboard",
    title: "PHP-specific onboarding",
    focus: "Audit-ready before your first partial hospitalization claim hits the payer.",
    summary: "We review your billing setup before PHP claims go live—not after denials start.",
    details: [
      "HCPCS and CPT crosswalk (S0201, H0015, H0035, G0410, G0129, revenue code 0912)",
      "PHP billing requirements, recertification, and treatment plan templates",
      "Bill types 131/132, UB-04 routing, and VOB for health php admissions",
    ],
  },
  {
    num: "02",
    ...
    summary: "Cipher works alongside clinical staff while the hospitalization program is running.",
    details: [
      "Daily utilization review and payer communication",
      "Recertification on day eighteen and thirty-day intervals",
      "Pre-bill validation on every institutional PHP claim",
    ],
  },
  {
    num: "03",
    ...
    summary: "We tighten cycle management RCM as rules change and your census grows.",
    details: [
      "Denial trend reviews with root-cause fixes at the source",
      "Medicare PHP and commercial policy updates on your crosswalks",
      "A/R follow-up and medical appeals when payers push back",
    ],
  },
] as const;

export default function PhpProcess() {
  return (
    <section id="php-process" className={`bg-white ${LANDING_SECTION_PY}`}>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-14">
          <div className="lg:self-center">
            ...
            <h2 className="mt-4 font-[var(--font-heading)] text-[1.75rem] font-medium leading-tight text-[#101E3F] md:text-[2rem]">
              How Cipher delivers <span className="text-[#166C96]">PHP billing services</span>
            </h2>
            <p className="mt-3 text-[15px] leading-[1.6] text-slate-600">
              Onboard → Manage → Optimize. Our engagement model for partial hospitalization program revenue cycle
              management—not a generic handoff after the first week of services billing.
            </p>
            <p className="mt-4 text-[14px] leading-[1.6] text-slate-600">
              Cipher stays involved from CPT and HCPCS review through daily UR and denial management, so your billing staff
              is not rebuilding insurance requirements every time census shifts between inpatient, PHP, and IOP levels of care.
            </p>
            ...
            <div className="mt-6 rounded-lg border border-[#166C96]/20 bg-[#F8FAFC] px-5 py-4">
