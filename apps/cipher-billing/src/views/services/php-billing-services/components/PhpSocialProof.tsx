...
/** Primary homepage testimonial (Dr. Matthew T.) — verbatim from cipherbilling.com. */
const testimonial = cipherHomeTestimonials[1]!;

export default function PhpSocialProof() {
  return (
      ...
      <div className={SERVICE_CONTAINER}>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 font-[var(--font-heading)] text-[1.75rem] font-medium leading-tight md:text-[2.125rem]">
            Trusted for behavioral health <span className="text-[#5eb5e0]">PHP billing services</span>
          </h2>
          <p className="mt-4 text-[14px] leading-[1.65] text-white/70">
            Same benchmarks we publish on our homepage for partial hospitalization programs—including a 9-minute average
            eligibility turnaround vs. an industry-standard 30 minutes for behavioral health PHP services.
          </p>
        </div>
