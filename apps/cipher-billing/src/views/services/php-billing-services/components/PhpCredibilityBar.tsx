...
const painPoints = [
  {
    ...
    body: "When authorizations slip or concurrent review lags on PHP services, claims pile up before anyone catches the gap.",
  },
  {
    icon: "ri-code-box-line",
    title: "Per diem & UB-04 complexity",
    body: "Per diem HCPCS, revenue code 0912, bill types 131/132, and UB-04 rules for partial hospitalization are not routine office-based billing workflows.",
  },
  {
    icon: "ri-close-circle-line",
    title: "Denials that stick",
    body: "Missing day-eighteen recertification, PHP-to-IOP overlap on the same dates, and wrong per diem or revenue code selection drive denials and lost partial hospitalization revenue.",
  },
] as const;

const trustSignals = [
  "Behavioral health RCM only",
  "Partial hospitalization & per diem PHP",
  "Medicare & commercial PHP coverage",
] as const;

export default function PhpCredibilityBar() {
  return (
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div className="lg:py-2">
            ...
            <h2 className="mt-3 font-[var(--font-heading)] text-[1.75rem] font-medium leading-tight text-[#101E3F] md:text-[2.125rem]">
              Partial hospitalization program billing is not standard IOP or office billing
            </h2>
            <p className="mt-4 text-[15px] leading-[1.65] text-slate-600">
              Mental health and substance use PHP services run on authorization windows, institutional billing codes, and
            ...
            <p className="mt-4 text-[15px] leading-[1.65] text-slate-600">
              ...
              management—partial hospitalization billing requirements and program services coding are core to what we do, not
              a side offering.
            </p>
