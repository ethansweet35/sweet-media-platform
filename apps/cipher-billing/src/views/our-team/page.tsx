...
/** 3-col grid from 768px — wider framed photos + `contain`/`bottom` keeps full portraits visible (cover was cropping heavily). */
const team = [
  {
    name: "Simon Jozani",
            ...
            {team.map((person) => (
              ...
              >
                <Image
                  ...
                  fill
                  sizes="(max-width: 767px) 100vw, (max-width: 1140px) 34vw, 360px"
