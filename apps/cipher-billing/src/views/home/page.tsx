          ...
          <div className="mt-16 grid gap-10 md:grid-cols-2 md:items-start">
            ...
            <div className="grid grid-cols-2 gap-4">
              {metrics.map((metric) => (
                <div
                  key={metric.label}
                  className="flex flex-col items-center justify-center border border-white/15 bg-[#0a1a30]/90 px-4 py-8 text-center"
                >
        ...
        <div className="mx-auto max-w-[1140px] px-6 pb-24">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {processSteps.map((step) => (
              <article
                key={step.step}
                className="flex min-h-full flex-col border border-white/25 bg-[#0D1833]/35 p-6"
              >
