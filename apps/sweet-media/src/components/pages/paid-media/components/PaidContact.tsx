...
export default function PaidContact() {
  ...
  return (
    <section id="paid-contact" className="w-full bg-[#0A1F44] py-[60px] md:py-[100px] px-4 md:px-6 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
              Get Your Free
              <br /><em className="font-light italic text-white/70">Media Audit.</em>
            </h2>
            <p className="text-white/50 text-sm leading-relaxed mb-10 max-w-md mx-auto lg:mx-0">
              We&apos;ll audit your existing ad accounts (or build a launch plan if you&apos;re starting fresh), identify wasted spend, and hand you a prioritized action plan — no pitch, no commitment.
            </p>

            <div className="flex flex-col gap-4 mb-12">
              {[
                { icon: "ri-search-line", title: "Full Account Audit", desc: "Every active campaign reviewed for structural issues, bid errors, and missed keyword coverage." },
                { icon: "ri-bar-chart-line", title: "Wasted Spend Analysis", desc: "We identify exactly where budget is leaking so you can redirect it to what actually converts." },
                { icon: "ri-money-dollar-circle-line", title: "CPL & ROAS Benchmarking", desc: "Compare your current performance against BH industry benchmarks — see where you stand." },
                { icon: "ri-file-list-3-line", title: "90-Day Growth Plan", desc: "A concrete action plan with channel recommendations, budget allocation, and projected outcomes." },
              ].map((item) => (
          ...
          <div className="bg-white/[0.06] border border-white/12 rounded-2xl overflow-hidden backdrop-blur-sm">
            <div className="px-7 pt-8 pb-6 border-b border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[9px] tracking-[0.4em] uppercase text-white/45 font-medium">Free Media Audit</span>
              </div>
              <h3 className="text-2xl font-bold text-white mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>
                Let&apos;s Audit Your Ad Spend.
              </h3>
              <p className="text-white/45 text-xs leading-relaxed font-light">
                Tell us about your facility and we&apos;ll put together a complete paid media audit — free, no strings attached.
              </p>
            </div>
              ...
              {submitted ? (
                <div className="py-10 flex flex-col items-center text-center gap-4">
                  ...
                  <p className="text-white/45 text-xs leading-relaxed max-w-[260px] font-light">
                    Our paid media team will review your accounts and deliver your audit within 5 business days.
                  </p>
                </div>
              ) : (
                <form
                 
                  id="paid-media-contact-form"
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1.5">
                      ...
                      >
                        <option value="" className="text-black">Program type...</option>
                        <option value="Residential Treatment" className="text-black">Residential</option>
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[9px] tracking-[0.3em] uppercase text-white/45 font-medium">Monthly Budget</label>
                      <select
                        name="budget"
                        value={formState.budget}
                        onChange={(e) => setFormData({ ...formState, budget: e.target.value })}
                        className="bg-white/10 border border-white/15 text-white/80 text-sm px-4 py-3 rounded-xl focus:outline-none focus:border-white/40 transition-all font-light appearance-none cursor-pointer"
                      >
                        <option value="" className="text-black">Ad budget...</option>
                        <option value="Under $5K" className="text-black">Under $5K/mo</option>
                        <option value="$5K–$15K" className="text-black">$5K–$15K/mo</option>
                        <option value="$15K–$30K" className="text-black">$15K–$30K/mo</option>
                        <option value="$30K–$75K" className="text-black">$30K–$75K/mo</option>
                        <option value="$75K+" className="text-black">$75K+/mo</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      name="message"
                      placeholder="Your website URL and any notes about current campaigns or challenges..."
                      rows={3}
                      maxLength={500}
