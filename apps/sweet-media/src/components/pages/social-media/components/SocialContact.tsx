...
export default function SocialContact() {
  ...
  return (
    <section id="social-contact" className="w-full bg-[#0A1F44] py-[60px] md:py-[100px] px-4 md:px-6 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
              Get Your Free
              <br /><em className="font-light italic text-white/70">Social Audit.</em>
            </h2>
            <p className="text-white/50 text-sm leading-relaxed mb-10 max-w-md mx-auto lg:mx-0">
              We'll audit your social presence, review your content and community health, and hand you a prioritized action plan — no pitch, no commitment required.
            </p>

            <div className="flex flex-col gap-4 mb-12">
              {[
                { icon: "ri-search-line", title: "Full Social Audit", desc: "Every profile reviewed for content quality, engagement, and brand consistency." },
                { icon: "ri-bar-chart-line", title: "Competitor Analysis", desc: "See how your social presence stacks up against other facilities in your market." },
                { icon: "ri-chat-3-line", title: "Community Health Check", desc: "Response times, message volume, and crisis protocol assessment." },
                { icon: "ri-file-list-3-line", title: "90-Day Content Plan", desc: "A concrete content calendar and community strategy, delivered within 5 business days." },
              ].map((item) => (
          ...
          <div className="bg-white/[0.06] border border-white/12 rounded-2xl overflow-hidden backdrop-blur-sm">
            <div className="px-7 pt-8 pb-6 border-b border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[9px] tracking-[0.4em] uppercase text-white/45 font-medium">Free Social Audit</span>
              </div>
              <h3 className="text-2xl font-bold text-white mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>
                Let&apos;s Audit Your Social Presence.
              </h3>
              <p className="text-white/45 text-xs leading-relaxed font-light">
                Tell us about your facility and we&apos;ll put together a complete social media audit — free, no strings.
              </p>
            </div>
              ...
              {submitted ? (
                <div className="py-10 flex flex-col items-center text-center gap-4">
                  ...
                  <p className="text-white/45 text-xs leading-relaxed max-w-[260px] font-light">
                    Our social media team will review your profiles and deliver your audit within 5 business days.
                  </p>
                </div>
              ) : (
                <form
                 
                  id="social-media-contact-form"
                ...
                >
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      name="message"
                      placeholder="Your social media handles and any notes about current challenges..."
                      rows={3}
                      maxLength={500}
