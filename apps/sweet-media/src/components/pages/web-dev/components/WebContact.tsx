...
export default function WebContact() {
  ...
  return (
    <section id="web-contact" className="w-full py-[60px] md:py-[100px] px-4 md:px-6 overflow-hidden" style={{ background: "#0A1F44" }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
              Get Your Free
              <br /><em className="font-light italic" style={{color:'#7B9FD4'}}>Site Audit.</em>
            </h2>
            <p className="text-white/55 text-sm leading-relaxed mb-10 max-w-md mx-auto lg:mx-0">
              We'll analyze your current website for speed, conversion rate, mobile experience, and HIPAA compliance — then hand you a prioritized action plan.
            </p>

            <div className="flex flex-col gap-4 mb-12">
              {[
                { icon: "ri-search-line", title: "Full Site Audit", desc: "Speed, mobile, conversion, security, and HIPAA compliance — all documented." },
                { icon: "ri-bar-chart-line", title: "Competitor Analysis", desc: "See how your site stacks up against other facilities in your market." },
                { icon: "ri-speed-line", title: "Core Web Vitals Check", desc: "LCP, FID, CLS, and TTFB — every metric measured and benchmarked." },
                { icon: "ri-file-list-3-line", title: "90-Day Growth Plan", desc: "A concrete rebuild or optimization roadmap, delivered within 5 business days." },
              ].map((item) => (
                <div key={item.title} className="flex items-start gap-4">
                  <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-white/15 flex-shrink-0">
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                { icon: "ri-shield-check-line", label: "HIPAA-Aware Hosting" },
                ...
                <div key={b.label} className="flex items-center gap-2 bg-white/10 border border-white/15 rounded-lg px-3 py-2.5">
                  <i className={`${b.icon} text-white/45 text-sm`}></i>
                  <span className="text-xs text-white/65 font-medium whitespace-nowrap">{b.label}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white/[0.07] border border-white/15 rounded-2xl overflow-hidden backdrop-blur-sm">
            <div className="px-7 pt-8 pb-6 border-b border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[9px] tracking-[0.4em] uppercase text-white/45 font-medium">Free Site Audit</span>
              </div>
              <h3 className="text-2xl font-bold text-white mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>
                Let&apos;s Audit Your Website.
              </h3>
              <p className="text-white/45 text-xs leading-relaxed font-light">
                Tell us about your facility and we&apos;ll put together a complete site audit — free, no strings.
              </p>
            </div>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      name="message"
                      placeholder="Your website URL and any notes about current challenges..."
                      rows={3}
                      maxLength={500}
