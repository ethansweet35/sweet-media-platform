        ...
        {mobileOpen && (
          <div className="md:hidden bg-white border-t border-neutral-100 px-6 py-6 flex flex-col gap-5">
            ...
            <div className="pt-2 border-t border-white/10 flex flex-col gap-3">
              <a href="tel:+17143005115" className="text-[11px] text-white/35 font-mono">(714) 300-5115</a>
              <a href="#seo-contact" className="bg-white text-black text-[11px] tracking-[0.18em] uppercase font-bold px-5 py-3 rounded-full text-center cursor-pointer whitespace-nowrap">
                Free SEO Audit
              </a>
            </div>
          </div>
