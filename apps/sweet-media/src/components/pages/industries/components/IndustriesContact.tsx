...
export default function IndustriesContact() {
  ...
  return (
    <section id="industries-contact" className="w-full bg-[#0A1F44] py-[60px] md:py-[100px] px-4 md:px-6 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
              Book Your Free
              <br /><em className="font-light italic text-white/70">Strategy Call.</em>
            </h2>
            <p className="text-white/50 text-sm leading-relaxed mb-10 max-w-md mx-auto lg:mx-0">
              Tell us about your facility and we'll put together a tailored marketing strategy — free, no strings. Every recommendation is specific to your program type and market.
            </p>

            <div className="flex flex-col gap-4 mb-12">
              {[
                { icon: "ri-search-line", title: "Industry-Specific Audit", desc: "We analyze your current digital presence through the lens of your specific program type and competitive landscape." },
                { icon: "ri-bar-chart-line", title: "Competitive Gap Analysis", desc: "See exactly what your competitors are doing that you're not — and where they're vulnerable." },
                { icon: "ri-map-pin-line", title: "Market Opportunity Map", desc: "A clear picture of your local and regional search opportunity, with realistic projections." },
          ...
          <div className="bg-white/[0.06] border border-white/12 rounded-2xl overflow-hidden backdrop-blur-sm">
            <div className="px-7 pt-8 pb-6 border-b border-white/10">
              ...
              <p className="text-white/45 text-xs leading-relaxed font-light">
                Tell us about your facility and we'll put together a complete strategy — free, no strings.
              </p>
            </div>
              ...
              {submitted ? (
                <div className="py-10 flex flex-col items-center text-center gap-4">
                  ...
                  <p className="text-white/45 text-xs leading-relaxed max-w-[260px] font-light">
                    Our team will reach out within 24 hours to schedule your strategy call.
                  </p>
                </div>
              ) : (
                <form
                 
                  id="industries-contact-form"
                ...
                >
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      name="message"
                      placeholder="Your website URL and any notes about your current marketing challenges..."
                      rows={3}
                      maxLength={500}
