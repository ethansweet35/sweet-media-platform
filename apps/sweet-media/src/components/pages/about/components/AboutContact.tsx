...
export default function AboutContact() {
  ...
  return (
    <section id="about-contact" className="w-full bg-[#0A1F44] py-[60px] md:py-[100px] px-4 md:px-6 overflow-hidden">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">

          {/* Left */}
          <div className="text-center lg:text-left">
            <p className="text-[10px] tracking-[0.35em] uppercase text-white/40 font-medium mb-4">Work With Us</p>
            <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
              Ready to Grow
              <br /><em className="font-light italic text-white/70">Your Census?</em>
            </h2>
            <p className="text-white/50 text-sm leading-relaxed mb-10 max-w-md mx-auto lg:mx-0">
              We take on a limited number of new clients each quarter to ensure every facility gets the attention it deserves. If you're ready to talk, we'd love to hear about your program.
            </p>

            <div className="flex flex-col gap-5 mb-12">
              {[
                { icon: "ri-map-pin-2-line", label: "129 W Wilson St, Costa Mesa, CA 92627", sub: "Serving clients nationwide" },
                { icon: "ri-phone-line", label: "(714) 300-5115", sub: "Mon–Fri, 9am–6pm PT" },
                { icon: "ri-mail-line", label: "emma@sweetmediaservices.com", sub: "We respond within 24 hours" },
              ].map((c) => (
          ...
          <div className="bg-white/[0.06] border border-white/12 rounded-2xl overflow-hidden backdrop-blur-sm">
            <div className="px-7 pt-8 pb-6 border-b border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[9px] tracking-[0.4em] uppercase text-white/45 font-medium">Free Strategy Call</span>
              </div>
              <h3 className="text-2xl font-bold text-white mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>
                Let's Talk About Your Program.
              </h3>
              <p className="text-white/45 text-xs leading-relaxed font-light">
                30-minute call — no pitch, just strategy tailored to your facility.
              </p>
            </div>
            ...
            <div className="px-7 py-7">
              {submitted ? (
                <div className="py-10 flex flex-col items-center text-center gap-4">
                  ...
                  <p className="text-white font-semibold text-base" style={{ fontFamily: "'Playfair Display', serif" }}>Message Received</p>
                ...
                <form id="about-contact-form" onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[9px] tracking-[0.3em] uppercase text-white/45 font-medium">Message</label>
                    <textarea name="message" placeholder="Tell us about your facility and what you're looking to achieve..." rows={3} maxLength={500} value={formState.message} onChange={(e) => { setFormData({ ...formState, message: e.target.value }); setCharCount(e.target.value.length); }} className="bg-white/10 border border-white/15 text-white text-sm px-4 py-3 rounded-xl placeholder-white/25 focus:outline-none focus:border-white/40 transition-all font-light resize-none" />
                  ...
                  <p className="text-white/25 text-[10px] text-center leading-relaxed">No commitment · 30 minutes · 100% free</p>
                </form>
              )}
            </div>
          </div>
