        ...
        <div className={CONTAINER}>
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="relative overflow-hidden rounded-2xl shadow-xl shadow-mbh-forest/10">
              ...
              <img src={SITE_IMAGES.therapyGroup} alt="Meth addiction treatment group therapy Missouri" className="w-full object-cover" style={{ aspectRatio: "4/3", objectPosition: "center" }} />
